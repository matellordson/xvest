    ...
    <div className="">
      ...
      <div className="flex h-screen w-full items-center justify-center lg:hidden">
        ...
        <div className="absolute flex h-screen w-screen flex-col items-center justify-center">
          <div className="h-[60%] w-full pt-2 text-center text-shadow">
            ...
            <p className="pb-5 pt-7 text-6xl font-semibold text-white text-shadow">
              Model X
            </p>
          </div>
          <div
      ...
      <div className="fixed hidden max-h-screen w-[100%] lg:flex">
        ...
        <div className="w-[60%]">
          ...
          />
          <div className="absolute bottom-0 top-0 h-full w-[60%]">
            <div className="h-[50%] w-full">
              <div className="pt-2 text-center text-shadow">
                <Link
                  href={"/protected/dashboard/portfolio"}
                  className="group ml-3 flex w-fit justify-center rounded-lg px-1 py-1 pr-2 font-semibold tracking-wide backdrop-blur-md"
                >
            ...
            <div className="h-[50%] w-full">
              <div className="flex h-full w-full flex-col items-center justify-start gap-y-9 pt-20">
                <div className="flex w-full items-center justify-between px-5 text-white">
                  <div className="flex flex-col items-center">
        ...
        {/* right */}
        <div className="w-[40%] overflow-y-hidden px-10">
          <div className="py-3">
            {/* checkout */}
            <div className="flex h-[4rem] items-center justify-between border-b border-dashed">
              <div className="">
              ...
              <div className="flex items-center justify-between gap-2">
                <form action="">
                  <SubmitButton formAction={order} className="tracking-wide">
                    Invest
                  </SubmitButton>
                </form>
              </div>
