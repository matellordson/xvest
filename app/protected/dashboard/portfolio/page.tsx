...
import TeslaOwned from "./(tesla-components)/tesla-owned";
import OwnedCount from "./(tesla-components)/(tesla-count)/owned-count";
    ...
    <div className="px-3">
      ...
      <div className="mt-3 space-y-3">
        <div className="divide-y rounded-lg border bg-skin px-3 py-1">
          ...
          <div>
            <a
              href={"https://www.tesla.com/compare"}
              target="_blank"
              className="flex items-center justify-between p-2"
            >
              <p>Compare Models</p>
